...
# ![](images/MB_Vert_3Clr.png){width="152"}                                       ![](Rplot.png){width="193"}
...
We obtained a sleep health dataset from Kaggle ([Sleep_Health_Dataset](https://www.kaggle.com/datasets/mohankrishnathalla/sleep-health-and-daily-performance-dataset?resource=download)) with 100,000 records. It includes variables related to sleep, lifestyle habits, and performance, such as sleep quality, stress, screen time, and cognitive performance. Each row represents one individual’s daily data.
